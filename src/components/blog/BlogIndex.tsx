              ...
              {BLOG_POSTS.map((post) => (
                <li key={post.slug}>
                  ...
                  >
                    ...
                    <h2 className="display-title mt-2 text-[1.5rem] font-semibold leading-[1.18] tracking-[-0.012em] text-sumi transition-colors group-hover/post:text-hinomaru md:text-[1.875rem]">
                      {post.title}
                    </h2>
                    <p className="mt-3 text-[1rem] leading-relaxed text-sumi-soft md:text-[1.0625rem]">
                      {post.description}
                    </p>
                    <span className="mt-4 inline-flex items-center gap-1.5 text-[13px] font-medium text-hinomaru/85 transition-colors group-hover/post:text-hinomaru">
                      Read post
                      <ArrowRight
