...
export const extended = (
  <>
    ...
    <P>
      Battery Sensei turns it into a rule. You pick a trigger — a percentage
      (say 20%) or an estimated time remaining (say 45 minutes) — and Sensei
      flips Low Power Mode on when you cross it. When you plug in again, it
    ...
    <P>
      ...
      which means the behaviour is exactly what macOS documents and nothing is
