...
export const extended = (
  <>
    ...
    <P>
      ...
      composite of CPU time, idle wake-ups, and other factors Apple weights
      but doesn’t publish in full. It’s the same number macOS uses to flag
      “apps that draw significant energy” in the battery menu, except
      surfaced live and rankable.
    </P>
    <P>
      Sensei reads that same score through the standard, sandboxed
      per-process APIs. No system extension, no kernel hooks, no privileged
      operations. The live{' '}
