...
export const extended = (
  <>
    ...
    <P>
      ...
      readings that matter — CPU, GPU, disk I/O, memory pressure — beside
    ...
    <UL>
      <li>
        <strong>CPU.</strong> The single best predictor of discharge rate.
        Click through for a per-core breakdown when one runaway thread is
        pinning a single core.
      </li>
      <li>
