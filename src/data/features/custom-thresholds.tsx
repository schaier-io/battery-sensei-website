...
export const extended = (
  <>
    ...
    <UL>
      <li>
        <strong>Info</strong> — a quiet card, auto-dismisses on a short
        timer (default 5–6 seconds). The first nudge that you’re heading
        toward a lower state of charge.
      </li>
      <li>
        <strong>Warning</strong> — a more visible card with a longer
        dismiss timer (default 10–12 seconds), or in some presets a red
        overlay. The "okay, find a charger now" moment.
      </li>
      <li>
        <strong>Alert</strong> — persistent until you acknowledge it.
        Reserved for when battery is genuinely low (5% or below by
        default). On the Senpai preset, the alert is a full-screen
        flasher.
      </li>
    </UL>
    <P>
    ...
    <P>
      Custom thresholds is a Premium feature. It’s included in the 5-day
      free trial and unlocks as part of the Lifetime license (one-time
      purchase, three Macs per license). The three built-in presets —{' '}
