import { P, H2, UL, G, A, Apple } from './_components'
...
export const extended = (
  <>
    ...
    <P>
      ...
      location, or charger identifiers — all of which fail in the obvious
      cases (hotel Wi-Fi the same SSID as home, a coffee-shop layover, a
    ...
    <UL>
      <li>
        <strong>30%</strong> — Info card, 6-second dismiss. The first nudge.
        Enough runtime to find a power outlet without rushing.
      </li>
      <li>
        <strong>15%</strong> — Warning, 12-second dismiss. By now your seat
        neighbor’s charger is the next move.
      </li>
      <li>
        <strong>5%</strong> — Alert, persistent until acknowledged. The
        plane will land before this matters, but Sensei makes sure you
        notice.
      </li>
    </UL>
    <P>
