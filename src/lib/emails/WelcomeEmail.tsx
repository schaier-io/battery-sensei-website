...
const COPY = {
  ...
  de: {
    ...
    expectBody: 'Etwa eine E-Mail pro Release — höchstens einmal im Monat. Tipps, Changelogs und gelegentlich ein Blick hinter die Kulissen. Keine Tracking-Pixel. Keine Werbung für andere Produkte.',
    sign: 'Mit Sorgfalt,',
  ...
  es: {
    ...
    expectBody: 'Aproximadamente un correo por lanzamiento — nunca más de una vez al mes. Consejos, changelogs y alguna nota entre bambalinas. Sin píxeles de seguimiento. Sin promociones de otros productos.',
    sign: 'Con cuidado,',
  ...
  fr: {
    ...
    expectBody: 'Environ un email par release — jamais plus d\'une fois par mois. Astuces, changelogs et parfois une note en coulisses. Pas de pixel de suivi. Pas de promo pour des produits tiers.',
    sign: 'Avec soin,',
